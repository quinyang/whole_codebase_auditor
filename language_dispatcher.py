...
class LanguageDispatcher:
    ...
    def _load_language(self, ext):
        ...
        # 2. Get the raw pointer (PyCapsule)
        language_ptr = language_module.language()
        
        # 3. WRAP IT (Crucial Fix)
        # The Parser expects a tree_sitter.Language object, not the raw capsule
